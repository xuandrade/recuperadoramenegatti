    ...
    <footer className="relative border-t border-white/[0.05] bg-carbon-900/60">
      <div className="container-x py-14">
        <div className="grid md:grid-cols-3 gap-10">
          <div>
            <img src="/logo.png" onError={(e) => { e.currentTarget.src = '/logo.svg'; }} alt="Recuperadora Menegatti" className="h-14 w-auto" />
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              {quick.map((l) => (<li key={l.href}><a href={l.href} className="text-white/70 hover:text-crimson-400 transition">{l.label}</a></li>))}
            </ul>
          </div>
          <div>
            <div className="text-[11px] uppercase tracking-[0.25em] text-white/45 font-semibold">Redes</div>
            <div className="mt-4 flex gap-3">
              <a href="https://www.google.com/search?q=Recuperadora+Menegatti" target="_blank" rel="noreferrer" className="rim inline-flex h-10 w-10 items-center justify-center rounded-full glass hover:border-crimson-500/40 hover:text-crimson-400 transition" aria-label="Google"><Globe className="h-4 w-4" /></a>
              <a href="https://www.facebook.com/" target="_blank" rel="noreferrer" className="rim inline-flex h-10 w-10 items-center justify-center rounded-full glass hover:border-crimson-500/40 hover:text-crimson-400 transition" aria-label="Facebook"><Facebook className="h-4 w-4" /></a>
            </div>
